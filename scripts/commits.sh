...
function help() {
  ...
  echo
  echo "Example:"
  echo "commits.sh -l scope-intro  -g PE101 -d"
  echo
...
if [ $DRY ]; then
  gh org-browse-repo -C -S $LAB  -P 10 -f ~/campus-virtual/${YEAR}/pl${YEAR}//pl${YEAR}apuntes-vuepress/${GROUP}.txt -d
else
  gh org-browse-repo -C -S $LAB  -P 10 -f ~/campus-virtual/${YEAR}/pl${YEAR}/pl${YEAR}apuntes-vuepress/${GROUP}.txt
fi