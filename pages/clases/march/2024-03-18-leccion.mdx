---
title: "Monday 2024/03/18"
published: true
summary: "Adding loops to the calculator language. Building a lexer generator"
labs: [ "while", "lexer-generator" ]
topics: 
  - text: "Regular Expressions and Lexical Analysis"
    href: "/topics/expresiones-regulares-y-analisis-lexico/README"
  - text: "Nearley.js"
...
[This video from the class 2023/03/14 from 18:03 to to 35:00 may help to overcome the gotchas when publishing a private npm module in the github package registry](/topics/introduction-to-javascript/publishing-npm-github).
