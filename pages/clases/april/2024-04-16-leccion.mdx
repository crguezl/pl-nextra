...
Clase del 2024/04/15: Interpreting the ASTs of Egg: Values, Word and Apply nodes. 
Meta functions and functions. The memory hierarchy.

<Videos ids={["5IWRiPZgOlM"]}></Videos>


Clase del 2024/04/10: Modifying the parser to use our lexer-generator instead of moo-ignore.
