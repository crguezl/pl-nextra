...
La mayor parte de los [libros](/references) son de libre acceso o están accesible via el [PuntoQ de la BULL](/resources/#bull).

* [Eloquent JS 3rd Edition](https://eloquentjavascript.net/)
* [Eloquent JS 2nd Edition](https://eloquentjavascript.net/2nd_edition/)
* <Link href={frontmatter().bull_permanente+'/5ljpb5/ullabsysULL00228966c-8'}>Compilers : principles, techniques, and tools.</Link> Alfred V. Aho Ravi Sethi; Jeffrey DavidUllman 1942-1988
...
* <Link href={frontmatter().bull_permanente+'15vbjs7/ullsfx3710000001127445'}>A Practical Approach to Compiler Construction.</Link> Watson. Año:2017 (Debes estar autenticado via PuntoQ BULL)
...
* [Programming Language Theory](https://github.com/steshaw/plt?tab=readme-ov-file) repo at steshaw/plt. See also the GitHub topics [programming-languages](https://github.com/topics/programming-languages) and [compilers](https://github.com/topics/compilers)
