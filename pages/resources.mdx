...
* <Link href={PLinfo.campus_virtual} alt="campus virtual" className={styles.link}>PL</Link>
* <Link href={PLinfo.participantes} className={styles.link}>Participantes</Link>
* <Link href={PLinfo.calificador} className={styles.link}>Calificaciones</Link>
* <Link href={PLinfo.tareas} className={styles.link}>Tareas</Link>
* <Link href={PLinfo.foros} className={styles.link}>Foros</Link>
* Aula de <Link href={PLinfo.covid_ull} className={styles.link}>Recursos Disponibles para Realizar ACTIVIDAD DOCENTE NO PRESENCIAL</Link>
* <Link href={PLinfo.udv} className={styles.link}>Unidad para la Docencia Virtual. Servicios (UDV)</Link>

### Guias Docentes

* <Link href={PLinfo.teacher_profile_edit} className={styles.link}>Modificación Perfíl del Profesor</Link> (deberá estar autenticado) 


### BULL

* <Link href={PLinfo.bull_puntoq} className={styles.link}>BULL PuntoQ</Link>
* <Link href="https://www.ull.es/servicios/biblioteca/servicios/videotutoriales-de-puntoq/" className={styles.link}>Video tutoriales de ayuda sobre PuntoQ</Link>


### Antiplagio

* <Link href={PLinfo.turnitin} className={styles.link}>Solicitud de informe de similitud</Link> Turnitin
...
* [Sede ULL](https://sede.ull.es/)
    ...
    - [Portafirmas de la ULL](https://sede.ull.es/portafirmas2/)
...
### Servicio de Propiedad Intelectual y Software

La [OTRI](https://www.ull.es/servicios/otc/) en su servicio de [Propiedad Intelectual y Software](https://www.ull.es/servicios/otc/proteccion/propiedad-intelectual-y-software/)
realiza los registros mediante [la plataforma Safe Creative](https://www.safecreative.org/) en dos pasos:
...
1. Comunícanos la intención de registrar tu desarrollo mediante el formulario de protección y analizaremos qué tipo registro y licencia es el más adecuado.
  * [Formulario](https://forms.gle/Yr86A4gTY73L7vFR6)
2. Nos pondremos en contacto para cumplimentar la documentación necesaria y nos envíes el código fuente en formato .zip
3. Te daremos un certificado de autoría y una prueba registral que te servirán para tu actividad de transferencia.
...
* [Introducción a GitPod](../topics/introduction-tojavascript/gitpod)

## Recursos Google

* [Google group de PL](https://groups.google.com/u/1/a/ull.edu.es/g/asignatura_139263121)
* <Link href={PLinfo.google_plus}>Comunidad Currents/Google+ PL</Link>
