...
3. Si no existen tokens en la parte derecha con precedencia asignada o bien si la precedencia por defecto no es la deseada, se puede usar la directiva `%prec` para asignar la precedencia deseada a la regla.
