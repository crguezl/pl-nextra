...
The software is now reaching an state in which we can make a [staging test](https://www.abtasty.com/blog/test-environment/) and thus we are intending to use it for the lab [left-side](/labs/left-side).
