...
1. Try writing different program examples of the new feature in the original language playing with the expressiveness of different syntactical approaches and also considering possible semantic variants. 
2. Add new rules to your grammar to support the new feature. 
3. Avoid ambiguity in the grammar.
...
```js filename="test/data/expectedjs/while.js" showLineNumbers copy {13-20} /prettier/
