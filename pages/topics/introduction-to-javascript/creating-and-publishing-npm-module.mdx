...
import AltaEnNpm from '@/pages/topics/introduction-to-javascript/alta-en-npm.mdx'
...
[Chai](https://chaijs.com/) frameworks. There are others you can use, like [Jest](/assets/topics/introduction-to-javascript/jest).
...
import DocumentingJavaScript from '@/pages/topics/introduction-to-javascript/documentation-guide.mdx'

<DocumentingJavaScript/>
...
`package.json`. If you are not familiar with 
[semantic versioning](https://semver.org/) aka **SemVer**, please add it to your reading list.
...
or using a [npm scope in the name](/assets/topics/introduction-to-javascript/nodejspackages.html#scoped-packages).
