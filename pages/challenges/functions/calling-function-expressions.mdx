...
A fact of interest is that the extension of the operations can lead to rethinking the syntax. For example, why not extend the call syntax to allow calls of the form `(f+g*h)(x)(y)`?
...
Extend your grammar to support this new syntax: after an expression between parenthesis can follow a call. 
