...
The summary of the idea being that you can do this in most languages:
...
8
```
But you can't do something like this (or equivalent) in any known programming language:
