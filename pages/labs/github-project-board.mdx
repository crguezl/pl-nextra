...
* Cuando en la corrección el profesor comenta que el requisito  esta cumplido **la cerramos**. Si el profesor indica que algo esta mal debe crearse una nueva incidencia que deberá ir a `TODO`.  Cuando crea que la haya arreglado la mueve a `done` y creará una incidencia mencionando al profesor de prácticas. 
...
* Vea este cideo con detenimiento:
