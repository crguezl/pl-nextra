...
rubrica:
  ...
  - Las operaciones artiméticas entre funciones son soportadas <code>(f+g)(x)</code> 
  ...
  - If you use AI tools, you should always include a statement in your <code>README.md</code> about how they were used in completion of the assignment.
  - El alumno se ha comprometido a no hacer uso de la IA que pueda impedir su crecimiento académico personal o pueda impedirle comprender un tema o idea
