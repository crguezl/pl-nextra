...
```js showLineNumbers filename="src/monkey-patch-case.js"
let Operators = {
...
En los cuestionarios relacionados se incluirán preguntas sobre el manejo de ast-types. Se recomienda ver los videos que se describen a continuación.
