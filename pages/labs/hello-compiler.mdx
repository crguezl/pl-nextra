...
Extienda  [el traductor de la calculadora](https://github.com/crguezl/hello-jison/blob/master/ast/minus-ast.jison) para que admita estas expresiones aritméticas y las traduzca a un programa JavaScript que las compute y las imprima.
...
Añada [pruebas](/temas/introduction-to-javascript/pruebas) usando [Mocha y Chai](/temas/introduction-to-javascript/mocha) o [Jest](/temas/introduction-to-javascript/jest)
...
See the notes in [covering](/temas/introduction-to-javascript/covering). 
...
Lea la sección [GitHub Actions](/temas/introduction-to-javascript/github-actions) de los apuntes.
...
* [Tipos de Nodos del AST](/temas/introduction-to-pl/espree-visitorkeys) y nombres de las propiedades de los hijos
