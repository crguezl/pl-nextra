...
If you compute factorials using the gamma function, you'll likely observe some small  errors due to  the fact that floating point numbers have limitations on how accurately a number can be represented. 
