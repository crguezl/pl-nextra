...
- [TOC](#toc)
- [Objetivos](#objetivos)
- [Opciones en línea de comandos](#opciones-en-línea-de-comandos)
- [Dealing with Ambiguity](#dealing-with-ambiguity)
- [Unary minus and exponentiation in escodegen](#unary-minus-and-exponentiation-in-escodegen)
- [Pruebas](#pruebas)
- [Covering](#covering)
- [References](#references)
  - [Essentials for this lab](#essentials-for-this-lab)
  - [Jison and Syntax Analysis](#jison-and-syntax-analysis)
...
Añada pruebas a este proyecto usando [mocha](/topics/introduction-tojavascript/mocha.html)
