...
rubrica:
   ...
   - Uses both CommonJS and ECMAScript
...
Añada pruebas a este proyecto usando [mocha](/topics/introduction-to-javascript/mocha)
...
The workflow is that for each feature we add an impit file `test/data/test2.calc`:
...
console.log(9 - 6 - 3);
```
Since it looks good we save it:
...
See also the sections [Testing with Mocha and Chai](/topics/introduction-to-javascript/creating-and-publishing-npm-module#testing-with-mocha-and-chai), [Writing the tests](/topics/introduction-to-javascript/creating-and-publishing-npm-module#writing-the-tests),
...
[Setting CI for our npm module](/topics/introduction-to-javascript/creating-and-publishing-npm-module#setting-ci-for-our-npm-module) in the chapter [Creating and Publishing an npm Module](/topics/introduction-to-javascript/creating-and-publishing-npm-module).
