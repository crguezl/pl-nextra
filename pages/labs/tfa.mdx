...
* Here you will find ideas related to extend the [Egg language](https://github.com/ULL-ESIT-PL-1819/egg)
* You can do this optional lab about extending Egg as TFA
  - [Extending the Egg Interpreter](/labs/extended-egg-interpreter)
* Of course, you can propose a TFA to extend the "calculator" language
...
## Extending Egg with OOP, currying, selectors ...

You can present as part of your TFA work the result of these labs:

1. [Extending the Egg Interpreter](/labs/extended-egg-interpreter)
...
You can also propose to add async and await to the calculator language.
...
[Scope Analysis and Translation: Translating From Egg to JavaScript](/topics/translation/egg-2-js) of this book/site/subject. This task implies the study and building of the  Scope Analysis stage. Make it as complete as possible.

An alternative is to implement to write a parser for the calculator language to produce Egg ASTs.
...
## Improve the Calculator with Syntax Sugar for Objects, Arrays, Classes and Inheritance
...
```ruby
a = [1;2;3;4] else 0 +[3;2;1] else 0,
write(a[0]), # 4
write(a[4]), # 4
write(a[5])  # 0
```

Propose syntactic sugars for classes and inheritance. 
